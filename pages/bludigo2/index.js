...
export default function Bludigo2() {
  const { data, loading } = useQuery(Bludigo2.query, {
    variables: Bludigo2.variables(),
  });
  ...
  return (
    <>
      ...
      <Main>
        <section
          id="hero"
          className="bg-gradient-to-br from-[#4f157e] via-[#1e387d] to-[#b3d0ff] h-[400px] md:h-[80vh] text-white md:flex items-center"
        >
        ...
        <div className="bg-gradient-to-r ">
          <Container>
            <section id="video-section" className="text-[#1e387d] md:my-20">
        ...
        <section className="lg:flex mb-20">
          <div className="bg-gradient-to-r from-[#1e387d] to-[#b3d0ff] lg:w-5/12  md:px-32 md:py-28">
            <h3 className="text-6xl text-white pb-12">
        ...
        <Container size="lg">
          <section className="mb-20">
            <p className="text-3xl md:text-5xl text-[#1e387d] md:w-2/3 pb-16">
          ...
          <section className="mb-16 text-center">
            <p className="text-bludigo mb-8 text-3xl font-bold">
              Read the full prescribing information
            </p>
            <button className="bg-bludigo py-4 px-10 text-white text-xl">
              LEARN MORE
            </button>
          </section>
          <section className="md:flex justify-evenly mb-16">
            <div className="bg-slate-400 p-8">
              <h5 className="text-3xl text-bludigo mb-4">
                Indications and Usage
              </h5>
              <a className="underline text-lg text-bludigo">
                Click to read more
              </a>
            </div>
            <div className="bg-gradient-to-r from-secondary to-white p-8">
              <h5 className="text-3xl text-bludigo mb-4">
                Product Information
              </h5>
