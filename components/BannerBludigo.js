...
export default function BannerBludigo() {
  return (
    <div className="w-full min-h-[400px] bg-white text-white md:flex justify-center items-center my-40">
      <div className="w-full md:max-h-[275px] md:p-6 bg-gradient-to-l from-[#31023d] to-primary text-white md:flex justify-center items-center">
        <Container size="md">
          ...
          <div className="md:w-1/2 px-2 py-10">
              ...
              <Link href="/bludigo">
                <button className="border-2 border-white px-6 py-[11px] rounded-lg text-xl">
